		...
		<header id="masthead" class="site-header wrap" role="banner">
			...
			<div class="new-menu">
				...
				<div class="left-menu">
					...
					<ul>
						<li class="menu-news"><a href="http://www.easternkicks.com/category/news">News</a></li>
						<li class="menu-reviews"><a href="http://www.easternkicks.com/category/reviews">Reviews</a></li>
						<li class="menu-interviews"><a href="http://www.easternkicks.com/category/interviews">Interviews</a></li>
						<li class="menu-features"><a href="http://www.easternkicks.com/category/features">Features</a></li>
						<li class="widgets-trigger">
							<a href="#" class="genericon more" title="<?php esc_attr_e( 'Full menu', 'ryu' ); ?>">
								<span class="screen-reader-text"><?php _e( 'Full menu', 'ryu' ); ?></span>
							</a>
						</li>
				...
				<hgroup>
					...
					<h2 class="site-description"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'description', 'display' ) ); ?>" rel="home"><?php bloginfo( 'description' ); ?></a></h2>
				</hgroup>
			
				</div>
				
				<div class="right-menu">
					<ul class="search-trigger">
						<li>
							<a href="#" class="genericon" title="<?php esc_attr_e( 'Search', 'ryu' ); ?>">
								<span class="screen-reader-text"><?php _e( 'Search', 'ryu' ); ?></span>
							</a>
